...
We offer three layers of reproducibility for the reviewers, recognizing that running the code on the entire dataset to generate the final figures may demand substantial resources. The layers are presented in from the easiest to the most resource-intensive:    
...
### 🛠️ **Layer 2**
This layer requires GPU resources. The objective of this layer is to run `Anubis` for already generated datasets. 

#### 📥 Download and Extract Datasets
Reviewers are required to download the datasets generated using the following models from the link below:    
...
Now we give a detailed description of how to run from scratch. This consists of 3 levels. 
