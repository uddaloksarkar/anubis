...
def truncate_on_stop_and_return(text, prompt): 
    try:        
        if not text.startswith(prompt):
            raise NameError("Prompt and generation do not match.")    
        else:
        ...
        raise NameError(f"Error in the text -> {text} : {e}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input_folder", help="The input folder containing the text.")
    parser.add_argument("prompts", help="Prompts and test cases")
    parser.add_argument("outputdir", help="Output directory for the results")
